...
const CartButton = dynamic(
  ...
  {
    ssr: false,
    loading: () => <Button disabled className="flex-1 bg-primary text-primary-foreground border-transparent">Add to cart</Button>
  },
);
          ...
          <div className="col-span-4">
            ...
            <div className="border-y flex">
              <div className="px-6 py-4 flex items-center justify-center border-r">
                <div className="px-3 py-1 rounded-full bg-primary/10 text-primary w-fit">
